...
import { Link, Page, Sheet } from "framework7-react";
          ...
          <div className="content">
            <div className="content-box">
              <div className="content-box__user text-center px-15px">
                ...
                {/* <div className="service">{item.prod.Title}</div> */}
                {arrReview && arrReview.map((x) => x.prod.Title).join(", ")}
              </div>
